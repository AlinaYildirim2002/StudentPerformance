...
You can install the development version of StudentPerformance from [GitHub](https://github.com/) with:
...
```
🧠 Example Entry Added
This is a basic example which shows you simple data entry
